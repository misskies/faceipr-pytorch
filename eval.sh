...
#
#CUDA_VISIBLE_DEVICES=3 python eval_LFW.py --batch_size=128 --model_path="/home/lsf/facenet-pytorch/trained_weight/faceweb_unmd_mobilenet/ep042-loss0.410-val_loss2.268.pth" --robustness="random_del" --test_rank=21 --post=LSB
#CUDA_VISIBLE_DEVICES=3 python eval_LFW.py --batch_size=128 --model_path="/home/lsf/facenet-pytorch/trained_weight/faceweb_unmd_mobilenet/ep042-loss0.410-val_loss2.268.pth" --robustness="combine" --test_rank=21 --post=LSB
#
