...
=======
        x: multi-task loss
>>>>>>> 7ce99248b4d7b2e72e04c9d1a3471d3c4a378c1b
    Examples：
        loss1=1
        loss2=2
...
def fit_one_epoch(model_train, model, loss_history, loss, loss2, optimizer, epoch, epoch_step, epoch_step_val, gen,
    ...
    for iteration, batch in enumerate(gen):
        ...
        if not fp16:
            ...
            #watermark_in = None
            #outputs1, outputs2, outputs3 = model_train(images, watermark_in, "origin")
        ...
        if local_rank == 0:
            pbar.set_postfix(**{'total_triple_loss': total_triple_loss / (iteration + 1),
                                ...
                                'accuracy': total_accuracy / (iteration + 1),
                                'total_wm_loss': total_watermark_loss / (iteration + 1),
>>>>>>> 7ce99248b4d7b2e72e04c9d1a3471d3c4a378c1b
...
=======
            pbar.set_postfix(**{'val_triple_loss': val_total_triple_loss / (iteration + 1),
                                ...
                                'val_total_wm_loss': val_total_watermark_loss / (iteration + 1),
                                'val_wm_accuracy': val_total_wm_accuracy / (iteration + 1),
>>>>>>> 7ce99248b4d7b2e72e04c9d1a3471d3c4a378c1b
                                'lr': get_lr(optimizer)})
            pbar.update(1)
