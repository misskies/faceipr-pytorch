...
def original_fit_one_epoch(model_train, model, loss_history, loss, loss2, optimizer, epoch, epoch_step, epoch_step_val, gen,
    ...
    for iteration, batch in enumerate(gen):
        ...
        if not fp16:
            ...
            watermark_in = None
            outputs1, outputs2 = model_train(images, watermark_in, "origin")
    ...
    if lfw_eval_flag:
        ...
        for _, (data_a, data_p, label) in enumerate(test_loader):
            with torch.no_grad():
                ...
                out_a, out_wa = model_train(data_a, watermark_in, "origin")
                out_p, out_wp = model_train(data_p, watermark_in, "origin")
